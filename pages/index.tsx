  ...
  <CustomNavbar/>
    ...
    <div className="mx-auto max-w-2xl py-10 sm:py-10 lg:py-10">
      <div className="hidden sm:mb-8 sm:flex sm:justify-center">
        ...
        New educational modules are released <a href="/modules/introduction" className="font-semibold text-cyan-800"><span className="absolute inset-0" aria-hidden="true"></span>Read more <span aria-hidden="true">&rarr;</span></a>
        </div>
      </div>
